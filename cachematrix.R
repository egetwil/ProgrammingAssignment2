...
## Programming Assignment 2 requires to write in R a pair of functions that cache 
## the inverse of a matrix, makeCacheMatrix function and cacheSolve function.
...
## makeCacheMatrix creates a special "matrix" object that can cache its inverse.
       ## Input parameter - the matrix "x"
       ## Output - a list containing a function to: 
          ## set the values of the initial matrix "x" 
          ## get the matrix 
          ## set the values of the inverse of the matrix, "invx" 
...
## If the inverse matrix has already been calculated (and the matrix
## has not changed), then the function cacheSolve should retrieve 
...
## There are test examples to evaluate functions makeCacheMatrix and cacheSolve 
## Results are copied from RStudio Console, C:Users/EGW/ProgrammingAssignment2
